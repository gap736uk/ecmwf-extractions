...
EXTRACT_BASE_DIR = '/scratch/ukc/era5_extract_pre_split/%s/'
EXTRACT_BASE_DIR_T = '/scratch/ukc/era5t_extract_pre_split/%s/'
EXTRACT_BASE_DIR_51 = '/scratch/ukc/era51_extract_pre_split/%s/'

PROCESSED_BASE_DIR = '/scratch/ukc/era5_extract/%s/'
PROCESSED_BASE_DIR_T = '/scratch/ukc/era5t_extract/%s/'
PROCESSED_BASE_DIR_51 = '/scratch/ukc/era51_extract/%s/'
